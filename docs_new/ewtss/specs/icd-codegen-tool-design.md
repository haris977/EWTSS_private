...
// Union for all COMM DF messages — use in React component props
...
Used by Mode B's React SPA (`Sg.Web`) to type-narrow incoming WebSocket messages by `groupId` / `unitId`.
